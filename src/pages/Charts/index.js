...
class Charts extends Component {
			...
			<div>
				<div className="crumbs">
					<Breadcrumb separator="/">
						<Breadcrumb.Item>
							<IconFont type="anticon-lx-rank" /> schart图表
						</Breadcrumb.Item>
					</Breadcrumb>
				</div>
				<div className="container">
					<div className="plugins-tips">
						schart.js：基于HTML5 Canvas的小图表库。 访问地址：
						<a href="https://github.com/lin-xin/sChart.js" target="_blank" rel="noopener noreferrer">
							schart.js
						</a>
					</div>
					<div>
	...
	changeData = () => {
		...
		[options1, options2] = [options2, options1];
		[options3, options4] = [options4, options3];
		this.setState({
			options1,
			options2,
			options3,
