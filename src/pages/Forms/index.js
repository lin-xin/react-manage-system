...
import { Form, Input, Select, TimePicker, DatePicker, Switch, Radio, Checkbox, Button, Breadcrumb, message, Col } from 'antd';
                ...
                <div className="container">
                    <Form labelCol={{ span: 4 }} wrapperCol={{ span: 20 }} style={{ width: '600px' }}>
                        ...
                        <Form.Item label="日期时间" required={true}>
                            <Col span={11}>
                                <Form.Item labelWidth="0px" style={{marginBottom: 0}}>
                                    {
                            ...
                            <Col style={{textAlign:'center'}} span={2}>-</Col>
                            <Col span={11}>
                                <Form.Item labelWidth="0px" style={{marginBottom: 0}}>
                                    {
