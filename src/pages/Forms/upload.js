			...
			<div>
				...
				<div className="container">
					...
					<div className="plugins-tips">
						Ant Design自带上传组件。 访问地址：
						<a href="https://ant.design/components/upload-cn/" target="_blank" rel="noopener noreferrer">
							Ant Design Upload
						</a>
					</div>
					...
					<div className="plugins-tips">
						react-cropper：一个封装了 Cropperjs 的 React 组件。 访问地址：
						<a
							href="https://github.com/roadmanfong/react-cropper"
							target="_blank"
